 ...
 */
public class ThirdHotBaseAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public ThirdHotBaseAdapter(List<ThirdChange> presentList, Context context, Callback3 callback3) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.third_listview2, parent, false);
            viewHolder.iconImg = (ImageView) convertView.findViewById(R.id.third_icon_listview2);
            viewHolder.nameTxt = (TextView) convertView.findViewById(R.id.third_name_listview2);
            viewHolder.remainTxt = (TextView) convertView.findViewById(R.id.third_remain_listview2);
            viewHolder.contentTxt = (TextView) convertView.findViewById(R.id.third_content_listview2);
            viewHolder.endTxt = (TextView) convertView.findViewById(R.id.third_get_listview2);
